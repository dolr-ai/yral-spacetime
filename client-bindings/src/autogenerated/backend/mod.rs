...
pub use add_notification_reducer::{
    add_notification, set_flags_for_add_notification, AddNotificationCallbackId,
};
...
impl TryFrom<__ws::ReducerCallInfo<__ws::BsatnFormat>> for Reducer {
    ...
    fn try_from(value: __ws::ReducerCallInfo<__ws::BsatnFormat>) -> __sdk::Result<Self> {
        match &value.reducer_name[..] {
            "add_notification" => Ok(__sdk::parse_reducer_args::<
                add_notification_reducer::AddNotificationArgs,
            >("add_notification", &value.args)?
            .into()),
