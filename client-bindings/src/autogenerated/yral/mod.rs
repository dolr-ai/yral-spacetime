...
pub mod liquidity_pools_table;
pub mod pump_and_dump_type;
pub mod register_new_user_reducer;
pub mod space_time_user_type;
pub mod user_table;

pub use client_connected_reducer::{
    client_connected, set_flags_for_client_connected, ClientConnectedCallbackId,
};
pub use liquidity_pool_type::LiquidityPool;
pub use liquidity_pools_table::*;
pub use pump_and_dump_type::PumpAndDump;
pub use register_new_user_reducer::{
    register_new_user, set_flags_for_register_new_user, RegisterNewUserCallbackId,
};
pub use space_time_user_type::SpaceTimeUser;
pub use user_table::*;
...
pub enum Reducer {
    ClientConnected,
    RegisterNewUser { principal: String },
}
...
impl TryFrom<__ws::ReducerCallInfo<__ws::BsatnFormat>> for Reducer {
    ...
    fn try_from(value: __ws::ReducerCallInfo<__ws::BsatnFormat>) -> __sdk::Result<Self> {
        match &value.reducer_name[..] {
            ...
            .into()),
            "register_new_user" => Ok(__sdk::parse_reducer_args::<
                register_new_user_reducer::RegisterNewUserArgs,
            >("register_new_user", &value.args)?
            .into()),
            unknown => {
                Err(
...
#[doc(hidden)]
pub struct DbUpdate {
    liquidity_pools: __sdk::TableUpdate<LiquidityPool>,
    user: __sdk::TableUpdate<SpaceTimeUser>,
}
    ...
    fn try_from(raw: __ws::DatabaseUpdate<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        ...
        for table_update in raw.tables {
            match &table_update.table_name[..] {
                "liquidity_pools" => {
                    db_update.liquidity_pools =
                        liquidity_pools_table::parse_table_update(table_update)?
                }
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.liquidity_pools = cache
            .apply_diff_to_table::<LiquidityPool>("liquidity_pools", &self.liquidity_pools)
            .with_updates_by_pk(|row| &row.principal);
        diff.user = cache
            .apply_diff_to_table::<SpaceTimeUser>("user", &self.user)
...
pub struct AppliedDiff<'r> {
    liquidity_pools: __sdk::TableAppliedDiff<'r, LiquidityPool>,
    user: __sdk::TableAppliedDiff<'r, SpaceTimeUser>,
}
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<LiquidityPool>(
            "liquidity_pools",
            &self.liquidity_pools,
            event,
        );
        callbacks.invoke_table_row_callbacks::<SpaceTimeUser>("user", &self.user, event);
    }
}
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        liquidity_pools_table::register_table(client_cache);
