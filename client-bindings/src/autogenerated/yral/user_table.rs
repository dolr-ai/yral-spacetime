...
use super::pump_and_dump_type::PumpAndDump;
use super::space_time_user_type::SpaceTimeUser;
...
pub struct UserTableHandle<'ctx> {
    imp: __sdk::TableHandle<SpaceTimeUser>,
...
impl UserTableAccess for super::RemoteTables {
    fn user(&self) -> UserTableHandle<'_> {
        UserTableHandle {
            imp: self.imp.get_table::<SpaceTimeUser>("user"),
...
impl<'ctx> __sdk::Table for UserTableHandle<'ctx> {
    type Row = SpaceTimeUser;
    type EventContext = super::EventContext;

    fn count(&self) -> u64 {
        self.imp.count()
    }
    fn iter(&self) -> impl Iterator<Item = SpaceTimeUser> + '_ {
        self.imp.iter()
    }
...
pub(super) fn register_table(client_cache: &mut __sdk::ClientCache<super::RemoteModule>) {
    let _table = client_cache.get_or_make_table::<SpaceTimeUser>("user");
...
) -> __sdk::Result<__sdk::TableUpdate<SpaceTimeUser>> {
    __sdk::TableUpdate::parse_table_update(raw_updates).map_err(|e| {
        __sdk::InternalError::failed_parse("TableUpdate<SpaceTimeUser>", "TableUpdate")
            .with_cause(e)
            .into()
    })
}
...
pub struct UserIdUnique<'ctx> {
    imp: __sdk::UniqueConstraintHandle<SpaceTimeUser, __sdk::Identity>,
...
impl<'ctx> UserIdUnique<'ctx> {
    ...
    pub fn find(&self, col_val: &__sdk::Identity) -> Option<SpaceTimeUser> {
