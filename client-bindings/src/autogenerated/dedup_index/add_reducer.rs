...
pub trait add {
    ...
    fn on_add(
        &self,
        callback: impl FnMut(&super::ReducerEventContext, &String, &String, &__sdk::Timestamp)
            + Send
            + 'static,
    ) -> AddCallbackId;
...
impl add for super::RemoteReducers {
    ...
    fn on_add(
        &self,
        mut callback: impl FnMut(&super::ReducerEventContext, &String, &String, &__sdk::Timestamp)
            + Send
            + 'static,
    ) -> AddCallbackId {
        AddCallbackId(self.imp.on_reducer(
            ...
            Box::new(move |ctx: &super::ReducerEventContext| {
                ...
                callback(ctx, hash, video_id, created_at)
            }),
        ))
    }
    fn remove_on_add(&self, callback: AddCallbackId) {
