...
pub mod add_deleted_canister_reducer;
pub mod deleted_canisters_table;
pub mod deleted_canisters_type;

pub use add_deleted_canister_reducer::{
    add_deleted_canister, set_flags_for_add_deleted_canister, AddDeletedCanisterCallbackId,
};
pub use deleted_canisters_table::*;
pub use deleted_canisters_type::DeletedCanisters;
...
pub enum Reducer {
    AddDeletedCanister { canister: String, user_id: String },
}
...
impl __sdk::Reducer for Reducer {
    fn reducer_name(&self) -> &'static str {
        match self {
            Reducer::AddDeletedCanister { .. } => "add_deleted_canister",
        }
    }
}
impl TryFrom<__ws::ReducerCallInfo<__ws::BsatnFormat>> for Reducer {
    ...
    fn try_from(value: __ws::ReducerCallInfo<__ws::BsatnFormat>) -> __sdk::Result<Self> {
        match &value.reducer_name[..] {
            "add_deleted_canister" => Ok(__sdk::parse_reducer_args::<
                add_deleted_canister_reducer::AddDeletedCanisterArgs,
            >("add_deleted_canister", &value.args)?
            .into()),
            unknown => {
                Err(
...
#[doc(hidden)]
pub struct DbUpdate {
    deleted_canisters: __sdk::TableUpdate<DeletedCanisters>,
}
    ...
    fn try_from(raw: __ws::DatabaseUpdate<__ws::BsatnFormat>) -> Result<Self, Self::Error> {
        ...
        for table_update in raw.tables {
            match &table_update.table_name[..] {
                "deleted_canisters" => {
                    db_update.deleted_canisters =
                        deleted_canisters_table::parse_table_update(table_update)?
                }
...
impl __sdk::DbUpdate for DbUpdate {
    fn apply_to_client_cache(
        ...
        diff.deleted_canisters = cache
            .apply_diff_to_table::<DeletedCanisters>("deleted_canisters", &self.deleted_canisters);
...
pub struct AppliedDiff<'r> {
    deleted_canisters: __sdk::TableAppliedDiff<'r, DeletedCanisters>,
}
...
impl<'r> __sdk::AppliedDiff<'r> for AppliedDiff<'r> {
    fn invoke_row_callbacks(
        ...
        callbacks.invoke_table_row_callbacks::<DeletedCanisters>(
            "deleted_canisters",
            &self.deleted_canisters,
            event,
        );
    }
}
...
impl __sdk::SpacetimeModule for RemoteModule {
    ...
    fn register_tables(client_cache: &mut __sdk::ClientCache<Self>) {
        deleted_canisters_table::register_table(client_cache);
    }
}
